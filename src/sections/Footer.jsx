  ...
  return (
    <footer className="relative overflow-hidden bg-neutral-900">
      ...
      <div className="relative z-10 width">
        <div className="w-full max-w-5xl px-4 xl:px-0 py-10 lg:pt-16 mx-auto flex justify-between">
          <div className="inline-flex items-center">
            ...
            <div className="border-s border-neutral-700 ps-5 ms-5">
              <p className="text-sm text-neutral-400">© 2025 Elevate Engage.</p>
            </div>
          </div>
          {/* <!-- Social Brands --> */}
          <div className="social">
            <div class="flex gap-3">
              {/* <!-- Facebook --> */}
              <a
                href="https://www.facebook.com/ElevateEngage.net"
                target="blank"
                class="size-8 flex justify-center items-center rounded-full border border-transparent text-gray-500 hover:bg-gray-50 dark:text-neutral-400 dark:hover:bg-neutral-700"
              ...
              <a
                target="blank"
                class="size-8 flex justify-center items-center rounded-full border border-transparent text-gray-500 hover:bg-gray-50 dark:text-neutral-400 dark:hover:bg-neutral-700"
                href="https://x.com/Elevate_Engage"
                aria-label="Twitter"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a
                target="blank"
                class="size-8 flex justify-center items-center rounded-full border border-transparent text-gray-500 hover:bg-gray-50 dark:text-neutral-400 dark:hover:bg-neutral-700"
                href="https://www.linkedin.com/company/elevate-engage/"
                aria-label="LinkedIn"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a
                target="blank"
                href="https://www.instagram.com/elevateengage/"
                class="size-8 flex justify-center items-center rounded-full border border-transparent text-gray-500 hover:bg-gray-50 dark:text-neutral-400 dark:hover:bg-neutral-700"
