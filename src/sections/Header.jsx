...
function Header() {
  return (
    <>
      <header data-theme="dark" className="relative -z-10 mb-12 bg-[url('/bggrid.png')] bg-cover bg-top">
        <div className="absolute -z-[1] w-full h-[500px]">
          <Aurora
        ...
        <section id="header" className="width">
